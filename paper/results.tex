...
When removing \texttt{qwen2.5-32b-instruct} the median went to 94\% implying that the lower question inconsistency was not due to ambiguity in the questions, but \texttt{qwen2.5-32b-instruct} lower reliability (72.2\% model consistency).
